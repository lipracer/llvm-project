...
// CHECK-LABEL: func @arith.floordivui_by_one
// CHECK-SAME: %[[ARG:[a-zA-Z0-9]+]]
func @arith.floordivui_by_one(%arg0: i32) -> (i32) {
  %c1 = arith.constant 1 : i32
  %res = arith.floordivui %arg0, %c1 : i32
  // CHECK: return %[[ARG]]
  return %res : i32
}

// CHECK-LABEL: func @tensor_arith.floordivui_by_one
// CHECK-SAME: %[[ARG:[a-zA-Z0-9]+]]
func @tensor_arith.floordivui_by_one(%arg0: tensor<4x5xi32>) -> tensor<4x5xi32> {
  %c1 = arith.constant dense<1> : tensor<4x5xi32>
  %res = arith.floordivui %arg0, %c1 : tensor<4x5xi32>
  // CHECK: return %[[ARG]]
  return %res : tensor<4x5xi32>
}
