...
// CHECK-LABEL: func @simple_floordivui
func @simple_floordivui() -> (i32, i32, i32) {
  %z = arith.constant 0 : i32
  // CHECK-DAG: [[C6:%.+]] = arith.constant 6
  %0 = arith.constant 6 : i32
  %1 = arith.constant 2 : i32
  ...
  // CHECK-DAG: [[C3:%.+]] = arith.constant 3 : i32
  %2 = arith.floordivui %0, %1 : i32

  %3 = arith.constant -2 : i32

  // Unsigned division interprets -2 as 2^32-2, so the result is 0.
  // CHECK-DAG: [[C0:%.+]] = arith.constant 0 : i32
  %4 = arith.floordivui %0, %3 : i32

  // CHECK-NEXT: [[XZ:%.+]] = arith.floordivui [[C6]], [[C0]]
  %5 = arith.floordivui %0, %z : i32
