...
// Test floor divide with unsigned integer
// CHECK-LABEL:       func @floordivui
// CHECK-SAME:     ([[ARG0:%.+]]: i32, [[ARG1:%.+]]: i32) -> i32 {
func @floordivui(%arg0: i32, %arg1: i32) -> (i32) {
  %res = arith.floordivui %arg0, %arg1 : i32
  return %res : i32
// CHECK:           [[RES:%.+]] = arith.divui [[ARG0]], [[ARG1]] : i32
}

// -----

// Test unsigned floor divide with index
// CHECK-LABEL:       func @floordivui_index
// CHECK-SAME:     ([[ARG0:%.+]]: index, [[ARG1:%.+]]: index) -> index {
func @floordivui_index(%arg0: index, %arg1: index) -> (index) {
  %res = arith.floordivui %arg0, %arg1 : index
  return %res : index
// CHECK:           [[RES:%.+]] = arith.divui [[ARG0]], [[ARG1]] : index
}
